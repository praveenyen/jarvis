...
import { getDisbursementListCreditLine } from '@/lib/queries/spiderman/service';
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const res = await getDisbursementListCreditLine(status, pageNumber, productType, groupDateFrom, groupDateTo,groupId,authHeaders);
